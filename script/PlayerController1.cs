...
public class PlayerController1 : MonoBehaviour
{
    ...
    public Transform saveXY;
    public float speed = 3;
    public float wallSlidingSpeed = 2;
    public float jumpSpeed = 6f;
    public float xWallForce = 4f, yWallForce = 6f;
    public bool canWallJump = false;
    public static bool canCtrl = true;
    private bool canSprinting = false, throughWall = false, canJumpTwice = false;
    private float sprintSpeed = 12f, sprintTime = 0.25f, sprintCD = 0.5f;//这个游戏里面用不到的能力就禁用了
    ...
    void Start()
    {
        ...
        {
            Debug.Log("人物坐标");
            playerXY.position =saveXY.position;
        }
        Load.flag = false;
